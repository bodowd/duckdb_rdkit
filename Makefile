...
EXT_NAME=duckdb_rdkit

#### Configuration for this extension
EXTENSION_NAME=DUCKDB_RDKIT
EXTENSION_FLAGS=\
-DDUCKDB_EXTENSION_NAMES="duckdb_rdkit" \
...
#### Main build
# For regular CLI build, we link the duckdb_rdkit extension directly into the DuckDB executable
...
#### Client tests
DEBUG_EXT_PATH='$(PROJ_DIR)build/debug/extension/duckdb_rdkit/duckdb_rdkit.duckdb_extension'
RELEASE_EXT_PATH='$(PROJ_DIR)build/release/extension/duckdb_rdkit/duckdb_rdkit.duckdb_extension'
